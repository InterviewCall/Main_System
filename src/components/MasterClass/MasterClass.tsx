        ...
        <div className='flex flex-col mt-8 gap-x-3 gap-y-2 md:gap-x-5 w-full'>
          <div className='flex md:flex-row flex-col gap-x-3 gap-y-2 w-full'>
            <p className='text-[#5a6273] flex text-[15px] md:text-[14.4px] gap-x-1'>
              ...
              <span>Saturday, July 05, 2025 6:30 PM (IST)</span>
            </p>
            <p className='text-[#5a6273] flex text-[15px] md:text-[14.4px] gap-x-1'>
              <span className='font-semibold'>ENDS ON:</span>
              <span>Saturday, July 05, 2025 8:00 PM (IST)</span>
            </p>
          </div>
          <p className='text-[#5a6273] flex text-[15px] md:text-[14.4px] gap-x-1'>
...
<br /> If you aspire to become a Software Engineer at top tech companies like Microsoft, Google, or Amazon, this session is for you! <br /> Join industry expert <span><b>Sunyul Hossen</b></span> on Saturday, <span><b>05th July</b></span>, from <span><b>6:30 PM</b></span> to <span><b>8:00 PM</b></span> as he shares insider strategies, key skills, and the mindset required to crack high-paying software engineering positions. Don’t miss out!
