...
// import { CallBackForm, callbackFormZodSchema } from '@/schemas/callbackFormSchema';

const HeaderButton: FC = () => {
    // const dialogRef = useRef<HTMLDialogElement>(null!);
    // const { register, formState: { errors } } = useForm<CallBackForm>({
    //   defaultValues: {
    //     selectExperience: '',
    //     selectPrograms: '',
    //     fullName: '',
    ...
    return (
      ...
      {/* Open the modal using document.getElementById('ID').showModal() method */}
        ...
        <div className='bg-white flex xl:flex-row flex-col xl:w-[50%] w-[90%] p-6 gap-8 rounded-md relative'>
          <button className='absolute right-0 top-0' onClick={() => dialogRef.current.close()}>
            <MdCancel size={30} />
          </button>
