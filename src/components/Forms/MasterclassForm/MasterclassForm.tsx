    ...
    return (
        ...
        {stepOtp ? (
          ...
          <form
            ...
            className='bg-white w-full rounded-lg md:max-w-[30vw] h-auto flex flex-col gap-y-4 md:fixed md:top-[26%] md:right-[2%] p-6 shadow-[2px_8px_15px_5px_rgba(0,0,0,0.1)]'
            noValidate
          >
